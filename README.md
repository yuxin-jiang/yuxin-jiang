...
* **2021.11**: 🎉🎉 Our paper *A Diversified Group Teaching Optimization Algorithm with a Segment-Based Fitness Strategy for UAV Route Planning* has been accepted by Expert Systems with Applications (ESWA).
* **2021.11**: 🎉🎉 Our paper *A Novel Multi-Objective Group Teaching Optimization Algorithm and Its Application to Engineering Design* has been accepted by Computers & Industrial Engineering (CAIE).
